...
\normalsize Document v1.81 \\
\normalsize Library v7.30
\end{flushright}
...
\hline
2 integers and 2 reals & index of a vertex and the edge index in the geomtric support mesh it is projected on followed by the barycentric position on this edge and the distance from it \\
\hline\hline
