...
static size_t GetPos(GmfMshSct *);
...
static void SetPos(GmfMshSct *, size_t);
...
static size_t GetPos(GmfMshSct *msh)
{
	int IntVal;
	size_t pos;
...
static void SetPos(GmfMshSct *msh, size_t pos)
{
	int IntVal;
